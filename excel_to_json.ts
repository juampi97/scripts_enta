...
function main(workbook: ExcelScript.Workbook): string {
    ...
    const table = workbook.getWorksheet("Generales").getTables()[0]; 
    // Obtiene la tabla InputsProceso de la hoja Generales
    // const table = workbook.getWorksheet("Generales").getTable('InputsProceso');
